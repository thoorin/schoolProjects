...
public class FBPost implements Comparable< FBPost >
{
    ...
    @Override 
    public int compareTo(FBPost post){
        int thisNumberOfComments = this.getComentarios().size();
        int otherNumberOfComments = post.getComentarios().size();
        
        return otherNumberOfComments - thisNumberOfComments ;
    }
